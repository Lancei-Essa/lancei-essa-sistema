...
- Simplificação dos escopos e adição explícita do escopo yt-analytics.readonly
- Adição de rota para forçar reconexão sem autenticação prévia
...
- Correção de erro de ESLint com window.confirm"
